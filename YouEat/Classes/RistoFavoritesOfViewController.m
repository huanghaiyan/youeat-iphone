//
//  RistoFavoritesOfViewController.m
//  YouEat
//
...
@implementation RistoFavoritesOfViewController
...
- (void)viewDidLoad {
	...
	NSString *urlString = [NSString stringWithFormat:@"/security/friendFavorite/%@", ristoID]; 
