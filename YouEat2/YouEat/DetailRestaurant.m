...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if (indexPath.row == 0) {        
            ...
            // RATING STARS LABEL
            UILabel *starLabel = [[[UILabel alloc] initWithFrame: CGRectMake(cell.indentationWidth, 35.0f, 10.0f, 10.0f)] autorelease];
            ...
            UILabel *starLabel2 = [[[UILabel alloc] initWithFrame: CGRectMake(cell.indentationWidth + 12.0f, 35.0f, 10.0f, 10.0f)] autorelease];
        ...
        if (indexPath.row == 1) {                
            // IMG LABEL
            UILabel *imgLabel = [[[UILabel alloc] initWithFrame: CGRectMake(cell.indentationWidth, 2.0f, 80.0f, 80.0f)] autorelease];
        ...
        if (indexPath.row == 2) {
            ...
            if(phoneNumber != nil && phoneNumber != NULL && (NSNull *)phoneNumber != [NSNull null]){
                ...
                UILabel *callButton = [[[UILabel alloc] initWithFrame: CGRectMake(cell.indentationWidth + 2.0f, 2.0f, 100.0f, 15.0f)] autorelease];
        ...
        // DESCRIPTION LABEL
            ...
            UITextView *descriptionView = [[[UITextView alloc] initWithFrame: CGRectMake(cell.indentationWidth, 2.0f, cell.frame.size.width - (cell.indentationWidth * 2) , 77.0f)] autorelease];
